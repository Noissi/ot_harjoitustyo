...
class MainView(QMainWindow):
    def __init__(self, handle_show_login_view=None, handle_show_game_view=None):
        super().__init__()
    ...
    def _initialise(self):
        ...
        button_skip = QPushButton('Peli')
        button_skip.clicked.connect(self._handle_show_game_view)
